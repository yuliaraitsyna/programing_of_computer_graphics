...
void letter::getIndexArray()
{
    ...
    setQuad(8, 13, 9, 10, 14);
    setQuad(9, 10, 14, 15, 11);
    setQuad(10, 8, 11, 15, 12);
    setQuad(11, 8, 9 , 13, 12);

    setQuad(12, 17, 16, 10, 11);
    setQuad(13, 4, 5, 16, 17);
    setQuad(14, 18, 19, 10, 11);
    setQuad(15, 4, 18, 10, 17);
    setQuad(16, 5, 19, 11, 16);

    setQuad(17, 15, 14, 21, 20);
    setQuad(18, 13, 12, 24, 25);
    setQuad(19, 22, 23, 21, 20);
    setQuad(20, 25, 14, 20, 22);
    setQuad(21, 24, 15, 21, 23);
}
